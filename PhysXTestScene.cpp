...
void PhysXTestScene::Initialize()
{
	...
	const PxMaterial* pDefaultMaterial{ pPhysX->createMaterial(0.5f,0.5f,1.01f) };
	...
	PxBoxGeometry boxGeometry{ PxBoxGeometry{0.5f * actorDimension.x, 0.5f * actorDimension.y, 0.5f * actorDimension.z} };
	...
	m_pCube->Translate(0.f, 20.f, 0.f);
